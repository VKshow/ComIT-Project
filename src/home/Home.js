      ...
      <div className="home__main-group">
        ...
        <Link className="home-link" to="/chatHome">
          <img
            ...
            alt="pic"
          />
          <div className="home-link-info">CHAT - PORTAL</div>
        </Link>

        <Link className="home-link" to="/game">
          <img
            className="home-game-img"
            src="https://www.incredible.co.za/media/catalog/product/cache/7ce9addd40d23ee411c2cc726ad5e7ed/e/x/exg_marvel_ikon_new_ps5_controller_front_hr_ecommerce_ae54.png"
            alt="pic"
          />
          <div className="home-link-info">GAME - PORTAL</div>
        </Link>
      </div>
      <div className="copyrights">© 2023 No one cares about copyrights</div>
    </div>
  );
};
